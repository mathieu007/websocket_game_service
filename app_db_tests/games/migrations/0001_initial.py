    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', games.fields.OrderField(blank=True)),
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='modules', to='games.game')),
            ],
            options={
                'ordering': ['order'],
            },
        ...
        #     model_name='game',
        #     name='subject',
        #     field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='games', to='games.subject'),
        # ),
        migrations.CreateModel(
            name='Content',
            fields=[
                ...
                ('module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contents', to='games.module')),
            ],
            options={
                'ordering': ['order'],
            },
